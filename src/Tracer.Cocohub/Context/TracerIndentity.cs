    ...
    public class TracerIndentity
    {
        ...
        public void Enter()
        {
            ...
            else
            {
                ...
                Console.WriteLine(string.Format("SpanId[{0}] error with wrong _lastSpanId[{1}]. TracerId:{2}", _spanId, _lastSpanId, _tracerId));
            }
        }
        ...
        public string EnterAsync()
        {
            ...
            {
                //剩下_spanId.Length == _lastSpanId.Length的情况, 理论上不会出现
                Console.WriteLine(string.Format("Async:SpanId[{0}] error with wrong _lastSpanId[{1}]. TracerId:{2}", _spanId, _lastSpanId, _tracerId));
            }
